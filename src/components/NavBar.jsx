    ...
    <div>
      <div className="navbar bg-base-100 shadow-lg px-4 fixed z-10">
        <div className="flex-1">
          <Link to='/' className="btn btn-ghost text-secondary gap-0 font-bold text-xl"> <span className="text-primary">Crazy</span>Byte</Link>
        </div>
        <div className="flex-none">
          <ul className="menu menu-horizontal px-1 hidden sm:flex items-center gap-3 font-bold">
